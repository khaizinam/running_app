...
export default Onboarding2 = function ({ navigation }) {

  return (
    <View style={styles.container}>
      <Image source={require("../assets/images/on2.jpg")} style={styles.logo} />
      <Text style={styles.title}>Thanh toán trực tuyến</Text>
      <Text style={styles.subtest}>
      Mua vé trực tuyến để đặt chỗ trước. Tiết kiệm thời gian
      </Text>
